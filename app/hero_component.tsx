...
const imageLoader = async () => {
  const imageLoader = await fetch(
    `https://cdn.contentful.com/spaces/${process.env.CONTENTFUL_SPACE_ID}/environments/master/assets/5QR5Dsru5NRfrTWsbBQ8UH?access_token=${process.env.CONTENTFUL_ACCESS_TOKEN}`,
  ).then((res) => res.json());
